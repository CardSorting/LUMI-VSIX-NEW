...
`;class Jr extends di{}const Zr=Jr.compose({baseName:"divider",template:Ao,styles:Yr}),Kr=(i,e)=>S`
	${V("inline-flex")} :host {
		background: ${bt};
		border-radius: calc(${Oe} * 1px);
		box-sizing: border-box;
...
`;class Aa extends U{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text area")}}const Ea=Aa.compose({baseName:"text-area",template:Jo,styles:Oa,shadowOptions:{delegatesFocus:!0}}),Da=(i,e)=>S`
	${V("inline-block")} :host {
		font-family: ${J};
		outline: none;
		user-select: none;
...
`;class Ba extends Q{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text field")}}const Pa=Ba.compose({baseName:"text-field",template:Zo,styles:Da,shadowOptions:{delegatesFocus:!0}}),{wrap:D}=nr(js,or());D(Er(),{name:"vscode-badge"});const Wa=D(Hr(),{name:"vscode-button"}),Qa=D(Nr(),{name:"vscode-checkbox",events:{onChange:"change"}});D(qr(),{name:"vscode-data-grid"});D(Xr(),{name:"vscode-data-grid-cell"});D(Wr(),{name:"vscode-data-grid-row"});D(Zr(),{name:"vscode-divider"});const Xa=D(ta(),{name:"vscode-dropdown",events:{onChange:"change"}}),Ya=D(na(),{name:"vscode-link"}),Ja=D(aa(),{name:"vscode-option"});D(ua(),{name:"vscode-panels",events:{onChange:"change"}});D(fa(),{name:"vscode-panel-tab"});D(ga(),{name:"vscode-panel-view"});const Za=D(ya(),{name:"vscode-progress-ring"});D(Ta(),{name:"vscode-radio",events:{onChange:"change"}});D($a(),{name:"vscode-radio-group",events:{onChange:"change"}});D(Ra(),{name:"vscode-tag"});D(Ea(),{name:"vscode-text-area",events:{onChange:"change",onInput:"input"}});const Ka=D(Pa(),{name:"vscode-text-field",events:{onChange:"change",onInput:"input"}});export{Ka as V,Wa as a,Qa as b,Ya as c,Xa as d,Ja as e,Za as f};
