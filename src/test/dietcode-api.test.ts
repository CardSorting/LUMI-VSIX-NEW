...
import type { DietCodeAPI } from "../exports/dietcode"
import { setVscodeHostProviderMock } from "./host-provider-test-utils"

describe("DietCodeAPI Core Functionality", () => {
	let api: DietCodeAPI
	...
	beforeEach(async () => {
		...
		// Create a mock controller that matches what the real createDietCodeAPI expects
		...
		// Create API instance
		api = createDietCodeAPI(mockController)
	})
