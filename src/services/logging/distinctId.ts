 ...
 */
export const _GENERATED_MACHINE_ID_KEY = "dietcode.generatedMachineId"
 ...
 * This is updated to DietCode User ID when authenticated.
 */
 ...
 * If authenticated, this will be the DietCode User ID.
