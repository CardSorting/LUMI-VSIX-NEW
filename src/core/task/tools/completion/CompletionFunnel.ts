...
export async function continueCompletionAttempt(
	...
	const proposedEvent: CompletionFunnelEvent = {
		...
		nextAllowedAction: "none",
		forbiddenActions: ["attempt_completion"],
		canonicalInstruction: "Completion proposal passed verification and is being finalized.",
		reason: "Task completion passed the proposal checks and is proceeding to finalization.",
