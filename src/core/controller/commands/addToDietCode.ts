...
export async function addToDietCode(controller: Controller, request: CommandContext, notebookContext?: string): Promise<Empty> {
	...
	Logger.log("addToDietCode", request.selectedText, filePath, request.language)
