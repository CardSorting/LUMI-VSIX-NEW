 ...
 */
export function convertApplyPatchToolCalls(messages: Array<DietCodeStorageMessage>): Array<DietCodeStorageMessage> {
 ...
 */
export function convertWriteToFileToolCalls(messages: Array<DietCodeStorageMessage>): Array<DietCodeStorageMessage> {
	// Map to track tool_use_id to converted tool info and original input
