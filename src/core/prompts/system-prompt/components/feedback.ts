...
- DOCS_SEARCH: For product/capability queries ("can DietCode do..."), use web_fetch on https://docs.dietcode.bot (subpages: getting-started, model-selection, features, task-management, prompt-engineering, dietcode-tools, enterprise, more-info).`
