...
3. Use available tools and repository context to infer required values and sensible defaults. If a required value cannot be found, choose the least disruptive fallback, state the assumption, and continue without asking follow-up questions. Do not ask about optional parameters.
