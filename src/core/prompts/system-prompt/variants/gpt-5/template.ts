...
- You may use multiple tools in a single response when the operations are independent (e.g., reading several files, creating independent files). For dependent operations, use each returned tool result before choosing the next action. Continue without waiting for a user response.{{BROWSER_WAIT_RULES}}`
