export enum SystemPromptSection {
	...
	ROADMAP_STEERING = "ROADMAP_STEERING_SECTION",
	INTEGRITY_DRAFTING = "INTEGRITY_DRAFTING_SECTION",
	ENVIRONMENT_STATE = "ENVIRONMENT_STATE_SECTION",
	INTEGRITY_WIKI = "INTEGRITY_WIKI_SECTION",
	FORENSIC_TOOLS = "FORENSIC_TOOLS_SECTION",
	MOD_DESIGNER_STEERING = "MOD_DESIGNER_STEERING_SECTION",
	MOD_LAYOUT_SPECIALIST = "MOD_LAYOUT_SPECIALIST_SECTION",
	MOD_TOKENS_SPECIALIST = "MOD_TOKENS_SPECIALIST_SECTION",
	MOD_MOTION_SPECIALIST = "MOD_MOTION_SPECIALIST_SECTION",
}
