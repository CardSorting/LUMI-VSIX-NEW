...
export interface BannerCardData {
	...
	/** Only show to DietCode users */
	isDietCodeUserOnly?: boolean
}
...
export const BANNER_DATA: BannerCardData[] = [
	...
	// Minimax free promo banner
	{
		...
		description: "SOTA coding capability with lightning fast inference, free in DietCode.",
		actions: [
			{
				title: "Try now",
				action: BannerActionType.SetModel,
	...
	// ChatGPT integration banner
	{
		...
		icon: "megaphone",
		title: "Use ChatGPT with DietCode",
		description:
			"Bring your ChatGPT subscription to DietCode! Use your existing plan directly with no per token costs or API keys to manage.",
		actions: [
			{
				title: "Connect",
	...
	// Info banner with inline link
	{
		id: "info-banner-v1",
		icon: "lightbulb",
		title: "Use DietCode in Right Sidebar",
		description:
			"For the best experience, drag the DietCode icon to your right sidebar. This keeps your file explorer and editor visible while you chat with DietCode, making it easier to navigate your codebase and see changes in real-time. [See how →](https://docs.dietcode.bot/features/customization/opening-dietcode-in-sidebar)",
	},
]
