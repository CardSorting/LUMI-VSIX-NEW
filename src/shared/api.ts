...
export const cloudflareModels = {
	...
	"@cf/zai-org/glm-5.2": {
		...
		outputPrice: 4.4,
		cacheReadsPrice: 0.3,
		description: "GLM-5.2 is a frontier-scale reasoning model optimized for coding, tool use, and structured outputs.",
	},
	"@cf/moonshotai/kimi-k2.7-code": {
		...
		cacheReadsPrice: 0.16,
		description:
			"Kimi K2.7 Code is a frontier coding model with vision input capabilities, strong tool calling, and advanced reasoning.",
	},
} as const satisfies Record<string, ModelInfo>

// ClinePass
export type ClinePassModelId = keyof typeof clinePassModels
export const clinePassDefaultModelId = "cline-pass/qwen3.7-max"
...
export const nousResearchModels = {
	...
	"~anthropic/claude-opus-latest": {
		...
		cacheWritesPrice: 6.25,
		cacheReadsPrice: 0.5,
		description: "Always routes to the latest model in the Claude Opus family. Currently resolves to Claude Opus 4.8.",
	},
	"~google/gemini-flash-latest": {
		...
		cacheReadsPrice: 0.15,
		description:
			"Always routes to the latest model in the Google Gemini Flash family. Currently resolves to Gemini 3.5 Flash.",
	},
	"~openai/gpt-latest": {
		maxTokens: 128_000,
		...
		outputPrice: 30.0,
		cacheReadsPrice: 0.5,
		description: "Always routes to the latest model in the OpenAI GPT family. Currently resolves to GPT-5.5.",
	},
	"xiaomi/mimo-v2-pro": {
		maxTokens: 64_000,
		contextWindow: 1_000_000,
